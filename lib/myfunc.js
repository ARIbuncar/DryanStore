...
msg.quotedMsg.fromMe = msg.quotedMsg.sender === dryan.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
...
if (msg.key.fromMe){
msg.sender = dryan.user.id.split(':')[0]+'@s.whatsapp.net'
}
